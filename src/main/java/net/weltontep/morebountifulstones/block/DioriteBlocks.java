...
public class DioriteBlocks {
    ...
    public static final Block DIORITE_COBBLED_STAIRS = registerBlock("diorite/diorite_cobbled_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_COBBLED.getDefaultState(), AbstractBlock.Settings.create().strength(2f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_SMOOTH_STAIRS = registerBlock("diorite/diorite_smooth_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_SMOOTH.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_SMOOTH_CRACKED_STAIRS = registerBlock("diorite/diorite_smooth_cracked_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_SMOOTH_CRACKED.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_LARGE_BRICK_STAIRS = registerBlock("diorite/diorite_polished_large_brick_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_LARGE_BRICKS.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_LARGE_BRICK_CRACKED_STAIRS = registerBlock("diorite/diorite_polished_large_brick_cracked_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_LARGE_BRICKS_CRACKED.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_SQUARE_BRICK_STAIRS = registerBlock("diorite/diorite_polished_square_brick_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_SQUARE_BRICKS.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_SQUARE_BRICK_CRACKED_STAIRS = registerBlock("diorite/diorite_polished_square_brick_cracked_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_SQUARE_BRICKS_CRACKED.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_TILE_STAIRS = registerBlock("diorite/diorite_polished_tile_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_TILES.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_TILE_CRACKED_STAIRS = registerBlock("diorite/diorite_polished_tile_cracked_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_TILES_CRACKED.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_SHINGLE_STAIRS = registerBlock("diorite/diorite_polished_shingle_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_SHINGLES.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CARVED_CIRCULAR_STAIRS = registerBlock("diorite/diorite_polished_carved_circular_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CARVED_CIRCULAR.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CARVED_CIRCULAR_PILLAR_STAIRS = registerBlock("diorite/diorite_polished_carved_circular_pillar_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CARVED_CIRCULAR_PILLAR.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CARVED_DENT_STAIRS = registerBlock("diorite/diorite_polished_carved_dent_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CARVED_DENT.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CARVED_DENT_PILLAR_STAIRS = registerBlock("diorite/diorite_polished_carved_dent_pillar_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CARVED_DENT_PILLAR.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CARVED_MOSAIC_STAIRS = registerBlock("diorite/diorite_polished_carved_mosaic_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CARVED_MOSAIC.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CARVED_MOSAIC_PILLAR_STAIRS = registerBlock("diorite/diorite_polished_carved_mosaic_pillar_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CARVED_MOSAIC_PILLAR.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_STAIRS = registerBlock("diorite/diorite_polished_cut_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_CRACKED_STAIRS = registerBlock("diorite/diorite_polished_cut_cracked_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_CRACKED.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_BRICK_STAIRS = registerBlock("diorite/diorite_polished_cut_brick_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_BRICKS.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_BRICK_CRACKED_STAIRS = registerBlock("diorite/diorite_polished_cut_brick_cracked_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_BRICKS_CRACKED.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_BRICK_BRAIDED_STAIRS = registerBlock("diorite/diorite_polished_cut_brick_braided_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_BRICKS_BRAIDED.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_BRICK_BRAIDED2_STAIRS = registerBlock("diorite/diorite_polished_cut_brick_braided2_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_BRICKS_BRAIDED2.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_BRICK_PINWHEEL_STAIRS = registerBlock("diorite/diorite_polished_cut_brick_pinwheel_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_BRICKS_PINWHEEL.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_BRICK_PINWHEEL2_STAIRS = registerBlock("diorite/diorite_polished_cut_brick_pinwheel2_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_BRICKS_PINWHEEL2.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_BRICK_ROAD_STAIRS = registerBlock("diorite/diorite_polished_cut_brick_road_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_BRICKS_ROAD.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_BRICK_ROAD2_STAIRS = registerBlock("diorite/diorite_polished_cut_brick_road2_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_BRICKS_ROAD2.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_PLANK_STAIRS = registerBlock("diorite/diorite_polished_cut_plank_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_PLANKS.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_PLANK_CRACKED_STAIRS = registerBlock("diorite/diorite_polished_cut_plank_cracked_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_PLANKS_CRACKED.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_PLANK_PILLAR_STAIRS = registerBlock("diorite/diorite_polished_cut_plank_pillar_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_PLANK_PILLAR.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_PLANK_PILLAR2_STAIRS = registerBlock("diorite/diorite_polished_cut_plank_pillar2_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_PLANK_PILLAR2.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_PILLAR_STAIRS = registerBlock("diorite/diorite_polished_cut_pillar_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_PILLAR.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_TILE_STAIRS = registerBlock("diorite/diorite_polished_cut_tile_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_TILES.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_TILE_DIAMOND_STAIRS = registerBlock("diorite/diorite_polished_cut_tile_diamond_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_TILES_DIAMOND.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CUT_TILE_PILLAR_STAIRS = registerBlock("diorite/diorite_polished_cut_tile_pillar_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CUT_TILE_PILLAR.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_PILLAR_STAIRS = registerBlock("diorite/diorite_polished_pillar_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_PILLAR.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_PILLAR2_STAIRS = registerBlock("diorite/diorite_polished_pillar2_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_PILLAR2.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CHISELED_TWISTED_STAIRS = registerBlock("diorite/diorite_polished_chiseled_twisted_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CHISELED_TWISTED.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CHISELED_GREEK_STAIRS = registerBlock("diorite/diorite_polished_chiseled_greek_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CHISELED_GREEK.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CHISELED_ORNATE_STAIRS = registerBlock("diorite/diorite_polished_chiseled_ornate_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CHISELED_ORNATE.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CHISELED_ORNATE2_STAIRS = registerBlock("diorite/diorite_polished_chiseled_ornate2_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CHISELED_ORNATE2.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block DIORITE_POLISHED_CHISELED_PYRAMID_STAIRS = registerBlock("diorite/diorite_polished_chiseled_pyramid_stairs",
            new StairsBlock(DioriteBlocks.DIORITE_POLISHED_CHISELED_PYRAMID.getDefaultState(), AbstractBlock.Settings.create().strength(1.5f,6f)
                    .requiresTool().sounds(BlockSoundGroup.STONE)));
